...
#define SAVEGAMEVERSION     9809  // Construction Yard pending wall-line and slab-area state
...
#define SIDEBAR_ACTION_BUTTON_TOP 146
#define SIDEBAR_ACTION_BUTTON_HEIGHT 36
#define SIDEBAR_OBJECT_INTERFACE_TOP (SIDEBAR_ACTION_BUTTON_TOP + SIDEBAR_ACTION_BUTTON_HEIGHT + 4)
